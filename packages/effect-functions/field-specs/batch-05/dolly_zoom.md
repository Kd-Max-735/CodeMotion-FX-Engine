...
相机真实前后移动，同时根据主体距离补偿垂直 FOV，使服务端绑定主体的投影尺寸基本恒定，产生经典空间压缩或扩张感。二维源素材使用中央主体保护区和严格单调的外围径向重映射，禁止把主体局部重复采样到背景区域。
