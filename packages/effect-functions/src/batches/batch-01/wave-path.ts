...
import {
  ...
  numberField, parameterSchema, readPath, resamplePath, round, roundPoint
} from "./common.js";
...
export const WAVE_PATH_DEFINITION: EffectToolDefinition<WavePathParams> = {
  ...
  inputSlots: [{ name: "source_path", kind: "data", required: true, cardinality: "one", description: "Server-bound normalized vector path geometry." }],
  ...
  render: (context, params) => {
    const source = readPath(context, "source_path");
